...
from encoding.ridge_utils.dsutils import make_semantic_model, make_word_ds, make_phoneme_ds
...
def get_story_wordseqs(stories):
	...
	with open("ds003020/derivative/respdict.json", "r") as f:
...
def get_eng1000_vectors(allstories):
	...
	Returns:
		Dictionary of {story: downsampled vectors}
	"""
	eng1000 = SemanticModel.load(join("ds003020/derivative", "english1000sm.hf5"))
	wordseqs = get_story_wordseqs(allstories)
	vectors = {}
	for story in allstories:
