...
os.chdir(r"C:\Users\adywi\OneDrive - unige.ch\Documents\Sarcasm_experiment\NL_Project\Huth\encoding")
...
args = {
 "subject": "UTS01",  # Change this as needed
 "feature": "eng1000",  # Change this as needed
 "sessions": [1, 2, 3, 4, 5],
 "trim": 5,
 "ndelays": 4,
 "nboots": 50,
 ...
 "nchunks": 125,
 "singcutoff": 1e-10,
 "use_corr": False,  # store_true means default is False
 "single_alpha": False  # store_true means default is False
 } 
globals().update(args)
...
if __name__ == "__main__":
	...
	print(args)  # Inspect the args dictionary
	print(globals())  # Inspect all global variables
